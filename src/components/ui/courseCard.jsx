      ...
      >
        ...
        <div className='relative h-28 flex items-end px-5 pb-4 overflow-hidden' style={{ background: `${c.color}12` }}>
          ...
          <div className='absolute top-3 right-3 flex flex-col gap-1 items-end'>
            {c.students > 500 && (
              <span className='text-[9px] font-semibold uppercase tracking-wide px-2 py-0.5 rounded-full bg-amber-50 text-amber-500'>
                Popular
              </span>
            )}
            {c.type === 'VIP courses' && (
        ...
        <div className='px-5 pt-4 pb-5 space-y-4'>
          ...
          <div className='grid grid-cols-3 text-center text-xs text-gray-400 bg-gray-50 rounded-xl py-3'>
            ...
            <div>
              <p className='font-medium text-gray-600 text-sm'>{c.students.toLocaleString()}</p>
              <p className='text-[10px] mt-0.5'>Students</p>
            </div>
          </div>
          ...
          <div className='flex items-center justify-between pt-1'>
            ...
            <Button
              onClick={protect(() => setShowForm(true))}
